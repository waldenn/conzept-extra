...
const WikipediaBaseUrl = CONZEPT_WEB_BASE + '/explore/';
//const WikipediaBaseUrl = 'https://en.wikipedia.org/wiki/';
const WikidataBaseUrl = CONZEPT_WEB_BASE + '/explore/?l=' + conzept_language + '&t=wikipedia-qid&s=true&i=';
//const WikidataBaseUrl = 'https://www.wikidata.org/wiki/';
const FMABaseUrl = 'https://www.ebi.ac.uk/ols/ontologies/fma/terms?iri=http%3A%2F%2Fpurl.obolibrary.org%2Fobo%2FFMA_';
//const FMABaseUrl = 'https://www.ebi.ac.uk/ols/search?ontology=fma&q=';
//const FMABaseUrl = 'http://xiphoid.biostr.washington.edu/fma/fmabrowser-hierarchy.html?fmaid=';
const NeurolexBaseUrl = 'https://neurolex.org/wiki/';
const MeshBaseUrl = 'https://meshb.nlm.nih.gov/#/record/ui?ui=';
const NeuroNamesBaseUrl = 'https://braininfo.rprc.washington.edu/centraldirectory.aspx?ID=';
//const UBERONBaseUrl = 'https://purl.obolibrary.org/obo/UBERON_';
...
class TADetailViewer extends Component {
    ...
    renderWikidataGray(ids, label, target) {
        ...
        if ( firstLoad ){ // allow scrolling to section
          firstLoad = false;
    ...
    render() {
        ...
        const wd_url = '"../wikipedia/?t=&amp;l=' + conzept_language + '&amp;qid=' + wdEntityIDs[0] + '"';
        const conzeptIframe = '<iframe id="infoframe" onload="" name="infoframe" title="info" src=' + wd_url + ' allowvr="yes" allow="autoplay; fullscreen" allowfullscreen="" allow-downloads="" style="display: block; height: 99vh; filter: none;" width="100%" height="98%" frameborder="0"></iframe>';
        ...
        return (
            <div>
                ...
                <div dangerouslySetInnerHTML={{__html: conzeptIframe}} />
                ...
                {node.fmaId !== null ? <DetailLinks label="FMA ID" value={[node.fmaId]} baseUrl={FMABaseUrl} target="_blank" /> : null}
                <DetailLinks label="Wikipedia" value={wikipediaTitles} baseUrl={WikipediaBaseUrl} target="_blank" />
                <DetailLinks label="Wikidata" value={node.wikiDataId} baseUrl={WikidataBaseUrl} target="_blank" />

                {this.renderWikidataProperty(wdEntityIDs, 'P486', "Mesh ID", MeshBaseUrl)}

                {this.renderWikidataProperty(wdEntityIDs, 'P4394', "NeuroNames ID", NeuroNamesBaseUrl)}

                {this.renderWikidataProperty(wdEntityIDs, 'P2892', "UMLS CUI", UMLSBaseUrl)}
