...
<div class="sidebar">
    ...
    <form>
        <input v-model="searchText" id="search-input" type="text" class="mw-ui-input" placeholder="Search by title"/>
        ...
        <button v-on:click="search(searchText, $event)" ref="submitBtn" class="mw-ui-button mw-ui-constructive mw-ui-block margin-top-5"><b>search</b></button>
    </form>

    <h2 v-if="searchResult.length > 0 || searchStatus === 'done'">{{searchResult.length}} results</h2>
...
export default {
  ...
  data() {
    ...
    // get URL query, if any and set searchText
